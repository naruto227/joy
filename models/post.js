...
function Post(name, des_file, des_file_s) {
    this.name = name;
    this.des_file = des_file;
    this.des_file_s = des_file_s;
...
Post.prototype.save = function (callback) {
    ...
    var post = {
            name: this.name,
            des_file: this.des_file,
            des_file_s: this.des_file_s,
            time: time
        };
    //打开数据库
...
//一次获取十篇文章
Post.getTwel = function (name, page, callback) {
    //打开数据库
    mongodb.open(function (err, db) {
        if (err) {
            return callback(err);
